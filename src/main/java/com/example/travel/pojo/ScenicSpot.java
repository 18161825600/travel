...
public class ScenicSpot {
     ...
     * 获取对景点分类
     *
     * @return scenic_spot_types - 对景点分类
     */
    public String getScenicSpotTypes() {
        return scenicSpotTypes;
    }

    /**
     * 设置对景点分类
     *
     * @param scenicSpotTypes 对景点分类
     */
    public void setScenicSpotTypes(String scenicSpotTypes) {
        this.scenicSpotTypes = scenicSpotTypes == null ? null : scenicSpotTypes.trim();
    }
